...
def _recall(prediction, ground_truth):
        ...
        for paragraph in article["paragraphs"]:
            for qa in paragraph["qas"]:
                ...
                recall += metric_max_over_ground_truths(
                    _recall, prediction, ground_truths
                )
...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset_file", help="Dataset file", default="arcd.json")
    parser.add_argument(
        "--prediction_file", help="Prediction File", default="predictions.json"
    )
